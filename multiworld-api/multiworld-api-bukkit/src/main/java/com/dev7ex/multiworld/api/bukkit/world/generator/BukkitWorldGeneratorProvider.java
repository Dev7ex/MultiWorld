...
/**
 * Represents a provider for Bukkit world generators in a multi-world environment.
 * Extends WorldGeneratorProvider interface.
 * This interface provides functionality for managing Bukkit world generators.
 *
 * @author Dev7ex
 * @since 29.06.2023
 */
