...
public abstract class MultiWorldBukkitApiConfiguration extends DefaultPluginConfiguration implements MultiWorldApiConfiguration {
    ...
    public enum Entry {
        ...
        PLAYER_NOT_FOUND("player-not-found", "%prefix% §cThis player could not be found", false),
        ONLY_PLAYER_COMMAND("only-player-command", "%prefix% §cThis command can only performed by a player", false),

        SETTINGS_AUTO_LOAD("settings.auto-load", Collections.emptyList(), false),
        SETTINGS_RECEIVE_UPDATE_MESSAGE("settings.receive-update-message", true, false),
        SETTINGS_AUTO_GAMEMODE_ENABLED("settings.auto-game-mode-enabled", true, false),
        ...
        SETTINGS_DEFAULTS_END_WORLD("settings.defaults.end-world", "end-world", false),
        SETTINGS_DEFAULTS_NETHER_WORLD("settings.defaults.nether_world", "nether_world", false),
