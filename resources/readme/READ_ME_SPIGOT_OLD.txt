...
» README «
    ...
    You have found a bug? https://github.com/Dev7ex/MultiWorld/issues
    You have a Question? https://discord.gg/sk6Hn8Z3V8 or https://www.spigotmc.org/threads/multiworld.506959/
    Version 1.5.9 Need https://www.spigotmc.org/resources/faciliscommon-bukkit.107198/download?version=532652 Version 1.0.5-SNAPHOST
    ...
    If you like the plugin you can leave a review so that new users have a better experience
    If you need support, first make sure that you are really using this plugin and that you are also using the Spigot server software

» What is "MultiWorld"? «

    MultiWorld is a simple world management system for Minecraft
...
» Setup «
    ...
    Download https://www.spigotmc.org/resources/faciliscommon.107198/
...
All permissions follow the same schema <multiworld.command.world.COMMAND>
    ...
    /world create <Name> <WorldType | Seed | Generator>
    /world delete <World>
    /world flag <World> <Property> <Value>
    /world gamerule <World> <Gamerule> <Value>
    /world help
    /world import <World> <WorldType>
    /world info <World>
...
[MEDIA=youtube]spuN-nE42Ec[/MEDIA]

» Links «

    https://github.com/Dev7ex/MultiWorld
    https://bstats.org/plugin/bukkit/MultiWorld/15446

» Configuration «
[SPOILER="config.yml"]

[code=YAML]#    __  ___      ____  _ _       __           __    __
  ...
  commands:
    ...
    whitelist:
      ...
      remove:
        ...
        successfully-removed: '%prefix% §7You have %player_name% §7removed from the §b%world_name% §7whitelist'[/code]
